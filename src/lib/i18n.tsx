...
const dict = {
  ar: {
    ...
    save: 'حفظ المنتج', cancel: 'إلغاء',
    stockNote: 'الكمية المدخلة هنا تُسجَّل كحركة استلام (رصيد افتتاحي) في الفرع المختار — لاحقًا تُضاف الكميات عبر استلام شحنة',
    // item details (wording as the client listed it)
    image: 'صورة المنتج', addImage: 'إضافة صورة', changeImage: 'تغيير الصورة', removeImage: 'إزالة الصورة',
    imageError: 'تعذّر قراءة الصورة، جرّب صورة أخرى', imageHint: 'من الكاميرا أو المعرض — تُصغَّر تلقائيًا',
    itemName: 'اسم المنتج', itemCode: 'كود المنتج', itemType: 'فئة المنتج', typeOfItem: 'نوع الصنف', pickType: 'اختر نوع الصنف',
    itemQty: 'كمية المنتج', salePrice: 'سعر البيع $', costPrice: 'سعر التكلفة $',
    supplierName: 'اسم المورد', pickSupplier: 'اختر المورد', newSupplier: 'مورد جديد…', newSupplierName: 'اسم المورد الجديد',
    qtyPerVariant: 'الكمية لكل مقاس × لون', totalQty: 'إجمالي الكمية', noQtyHint: 'سيُنشأ المنتج بدون كمية — تُضاف لاحقًا عبر استلام شحنة',
    inStock: 'متوفر', outOfStock: 'نفدت الكمية', stockStatus: 'حالة التوفر', branchPlaced: 'الفرع الموضوع فيه',
    stockAtBranch: 'الكمية والتوفر حسب فرع', itemDetails: 'تفاصيل المنتج', perVariant: 'حسب المقاس واللون',
    codeTaken: 'هذا الكود مستخدم', openingStock: 'رصيد افتتاحي', noImage: 'بدون صورة',
    // demo-readiness pass
    lydShort: 'د.ل', badPayment: 'المبلغ المدفوع غير صالح', dayClosedRefused: 'أُقفل هذا اليوم — لا يمكن تسجيل حركات جديدة في هذا الفرع',
    stockRefused: 'الكمية غير كافية بالفرع المصدر', alreadyReturned: 'مُرتجَع', nothingToReturn: 'كل الأصناف المختارة مُرتجَعة من قبل',
    transferRequested: 'أُرسل طلب التحويل', transferSent: 'أُرسلت الشحنة', transferReceived: 'تم استلام التحويل',
    poCreated: 'أُنشئ أمر الشراء', poReceivedToast: 'تم استلام الشحنة وتحديث المخزون', closePo: 'إغلاق الأمر', poLineHint: 'أدخل الكمية وسعر الوحدة لكل صنف',
    stockCountNote: 'الجرد يُرحَّل كتسوية واحدة في حركات المخزون — الكمية المعدودة تصبح هي الرصيد',
    countResumed: 'استئناف جلسة الجرد المفتوحة', custExists: 'رقم الهاتف مسجّل لعميل آخر', expenseAdded: 'أُضيف المصروف',
    refundsToday: 'مرتجعات اليوم', showMore: 'عرض المزيد', showingOf: 'يظهر', ofTotal: 'من', onHandAt: 'المتوفر في',
    costMissing: 'التكلفة غير مُدخلة', editProduct: 'تعديل', saveChanges: 'حفظ التعديلات', prodUpdated: 'حُفظت التعديلات',
    allBranches: 'كل الفروع', currentBranch: 'الفرع الحالي', neverMovedHint: 'لم يُبَع منه أي قطعة', expensesOnly: 'مصروفات الفرع هذا الشهر',
    scanHint: 'اكتب الكود أو امسح الباركود',
  ...
  en: {
    ...
    stockNote: 'Quantities entered here are posted as a receipt (opening stock) into the chosen branch — later stock arrives via shipment receipts',
    // item details
    image: 'Item image', addImage: 'Add image', changeImage: 'Change image', removeImage: 'Remove image',
    imageError: 'Could not read that image, try another', imageHint: 'Camera or gallery — resized automatically',
    itemName: 'Item name', itemCode: 'Item code', itemType: 'Item type', typeOfItem: 'Item type', pickType: 'Choose a type',
    itemQty: 'Quantity', salePrice: 'Sale price $', costPrice: 'Cost price $',
    supplierName: 'Supplier', pickSupplier: 'Choose a supplier', newSupplier: 'New supplier…', newSupplierName: 'New supplier name',
    qtyPerVariant: 'Quantity per size × colour', totalQty: 'Total quantity', noQtyHint: 'The item will be created with no stock — add it later via a shipment receipt',
    inStock: 'In stock', outOfStock: 'Out of stock', stockStatus: 'Availability', branchPlaced: 'Branch it goes to',
    stockAtBranch: 'Quantity and availability at', itemDetails: 'Item details', perVariant: 'By size and colour',
    codeTaken: 'Code already in use', openingStock: 'Opening stock', noImage: 'No image',
    // demo-readiness pass
    lydShort: 'LYD', badPayment: 'Invalid payment amount', dayClosedRefused: 'This day is closed — no new movements can be posted at this branch',
    stockRefused: 'Not enough stock at the source branch', alreadyReturned: 'Returned', nothingToReturn: 'Every selected line was already returned',
    transferRequested: 'Transfer requested', transferSent: 'Shipment sent', transferReceived: 'Transfer received',
    poCreated: 'Purchase order created', poReceivedToast: 'Shipment received — stock updated', closePo: 'Close order', poLineHint: 'Enter a quantity and unit cost for every line',
    stockCountNote: 'A count posts as a single adjustment in the stock ledger — the counted quantity becomes the on-hand figure',
    countResumed: 'Resumed the open count session', custExists: 'That phone number belongs to another customer', expenseAdded: 'Expense added',
    refundsToday: 'Refunds today', showMore: 'Show more', showingOf: 'Showing', ofTotal: 'of', onHandAt: 'On hand at',
    costMissing: 'Cost not entered', editProduct: 'Edit', saveChanges: 'Save changes', prodUpdated: 'Changes saved',
    allBranches: 'All branches', currentBranch: 'Current branch', neverMovedHint: 'No unit ever sold', expensesOnly: 'Branch expenses this month',
    scanHint: 'Type the code or scan the barcode',
